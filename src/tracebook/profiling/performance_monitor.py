...
class PerformanceMonitor:
    ...
    def record_trade_execution(self, trade_count: int, total_volume: float):
        ...
        with self._lock:
            ...
            self.metrics_collector.record_metric(
                name="trades_per_batch", value=trade_count, unit="count", category="trading"
            )
    ...
    def get_performance_summary(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            avg_throughput = (
                self.session_metrics["orders_processed"] / uptime_seconds
                if uptime_seconds > 0
                else 0
            )
            ...
            summary = {
                ...
                "derived_metrics": {
                    ...
                    "orders_per_trade": (
                        self.session_metrics["orders_processed"]
                        / max(1, self.session_metrics["trades_executed"])
                    ),
                    "average_trade_size": (
                        self.session_metrics["total_volume"]
                        / max(1, self.session_metrics["trades_executed"])
                    ),
                },
    ...
    def print_summary(self):
        ...
        print(
            f"Average Throughput: {derived_metrics['average_throughput_ops_per_sec']:.1f} ops/sec"
        )
        ...
        if "order_processing_latency_ms" in perf_metrics:
            ...
            print(
                f"Latency - Mean: {latency_stats.get('mean', 0):.3f}ms, "
