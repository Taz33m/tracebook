...
| `integrations/intrepid_orderbook/` | Native Go protocol server over a pinned submitted-order CLOB, with FIFO qualification and an explicit FOK contract difference |
